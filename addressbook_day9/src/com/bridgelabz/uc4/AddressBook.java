...
public class AddressBook {
    	...
    	Contacts contacts = new Contacts();								//Created Contacts Object for Getter and Setter Methods
    ...
    public void editContact() {												//Method to Edit the Existing Contact
        ...
        String firstName = sc.next();   
        	if(!firstName.equalsIgnoreCase(contacts.getFirstName())) {		//check if the Given User with First Name
